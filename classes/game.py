...
# define color code for our littile game
class bcolors:
    HEADER = '\033[95m'
    OKBLUE = '\033[94m'
    OKGREEN = '\033[92m'
...
"""
define player class:
in this class we define all player parameters
we create a method for getting each parameter. 
we create a method for each action player or enemy can do 
"""
class player:
